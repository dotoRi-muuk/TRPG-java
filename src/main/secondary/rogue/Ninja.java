...
public class Ninja {
    ...
    public static Result plain(int stat, boolean illusion, boolean quickReflexes, boolean ideologySeal, int precision, PrintStream out) {
        ...
        return applyNinjaDamageLogic(baseDamage, stat, illusion, quickReflexes, ideologySeal, true, diceRoll, 0, 0, precision, out);
    }

    private static Result applyNinjaDamageLogic(int baseDamage, int stat, boolean illusion, boolean quickReflexes, boolean ideologySeal, boolean applyClone, int diceRoll, int staminaChange, int manaChange, int precision, PrintStream out) {
    ...
    public static Result strike(int stat, boolean illusion, boolean quickReflexes, boolean ideologySeal, int precision, PrintStream out) {
        ...
        return applyNinjaDamageLogic(baseDamage, stat, illusion, quickReflexes, ideologySeal, true, diceRoll, -2, 0, precision, out);
    }
    ...
    public static Result slash(int stat, boolean illusion, boolean quickReflexes, boolean ideologySeal, int precision, PrintStream out) {
        ...
        return applyNinjaDamageLogic(baseDamage, stat, illusion, quickReflexes, ideologySeal, true, diceRoll, -4, 0, precision, out);
    }
    ...
    public static Result phantomDance(int stat, boolean illusion, boolean quickReflexes, boolean ideologySeal, int precision, PrintStream out) {
        ...
        return applyNinjaDamageLogic(baseDamage, stat, illusion, quickReflexes, ideologySeal, false, diceRoll, -4, 0, precision, out);
    }
    ...
    public static Result allOutThrow(int dex, int speed, int numShurikens, boolean illusion, boolean quickReflexes, boolean ideologySeal, int precision, PrintStream out) {
        ...
        return applyNinjaDamageLogic(baseDamage, dex, illusion, quickReflexes, ideologySeal, true, diceRoll, 0, -3, precision, out);
    }
