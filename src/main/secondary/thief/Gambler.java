 ...
 * <p>
 * *   행운아 (패시브) : 판정 실패 시 [운] 판정을 성공시켜 1회 재판정이 가능합니다. (운 판정에는 사용할 수 없습니다.)<br>
 * *   일확천금 (패시브) : 자신의 [운] 스탯을 감소시킬 수 있습니다. 휴식 시에 다시 변경 가능합니다. 공격 발동에 [운] 판정이 성공할 시 해당 기술/스킬의 데미지가 (감소한 운 스탯) * 50% 만큼 증가합니다. (중첩 가능)<br>
 * *   액땜 (패시브) : 운 판정 실패 시 다음 성공까지 운 스탯이 +2 증가합니다. 운 스탯 증가는 중첩될 수 있습니다.<br>
 * 감수 (패시브) : 휴식 시 운 스탯 2개와 다른 스탯 1개를 교환할 수 있습니다. (한 가지 스탯으로만 바꿀 수 있으며, 체력, 스태미나, 마나는 불가능합니다.)<br>
 * <p>
 * -   코인 토스 (기술) : 대상에게 1D4의 피해를 입힙니다. 이후 운 판정 성공 시 D12의 피해를 입힙니다. (스태미나 1 소모)<br>
 * -   조커 카드 (기술) : 대상에게 1D6의 피해를 입힙니다. 이후 운 판정 성공 시 2D12의 피해를 입힙니다. (스태미나 3 소모)<br>
 * -   블랙잭 (기술) : 대상에게 1D6의 피해를 입힙니다. 이후 운 판정 성공 시 3D8의 피해를 입힙니다. (스태미나 3 소모)<br>
 * -   야추 다이스 (기술) : 대상에게 1D8의 피해를 입힙니다. 이후 운 판정 2회 성공 시 2D20의 피해를 입힙니다. (스태미나 4 소모)<br>
 * -   로얄 플러쉬 (기술) : 대상에게 1D4의 피해를 입힙니다. 이후 운 판정 3회 성공 시 4D20의 피해를 입힙니다. (스태미나 7 소모)<br>
 * <p>
 * -   흐름 (스킬) : 운 판정 성공 후 사용할 수 있습니다. 다음 턴까지 운 판정 스탯이 +3 증가합니다. 턴을 소모하지 않습니다. (마나 3 소모, 쿨타임 5턴)<br>
 * 잭팟 (스킬) : 모든 플레이어가 모든 스탯을 1 잃습니다. 모든 플레이어가 운 판정을 진행하여, 판정값이 가장 높은 플레이어가 해당 스탯을 전부 얻습니다. 스탯 변경은 이 전투에 한하여 지속됩니다. (마나 5 소모, 쿨타임 10턴)<br>
 * 룰렛 (스킬) : 모든 플레이어가 마나와 스태미나를 5씩 잃습니다. 모든 플레이어가 운 판정을 진행하여, 판정값이 가장 높은 플레이어가 해당 스탯을 전부 얻습니다. 스탯 변경은 이 전투에 한하여 지속됩니다. (전투 내 지속) (마나 5 소모, 쿨타임 8턴)<br>
 * 핀볼 (스킬) : 모든 플레이어가 힘과 민첩을 2 잃습니다. 모든 플레이어가 운 판정을 진행하여, 판정값이 가장 높은 플레이어가 해당 스탯을 전부 얻습니다. 스탯 변경은 이 전투에 한하여 지속됩니다. (전투 내 지속) (마나 4 소모, 쿨타임 8턴)<br>
 * 낙수패 (스킬) : 다음 턴까지 1개의 스탯이 0으로 감소합니다. 감소한 스탯만큼 운 스탯이 상승합니다. (마나 6 소모, 쿨타임 10턴)<br>
 * <p>
