 ...
 * <p>
 * *   암살 대상 (패시브) : 전투 시작 시 '전장 이탈' 상태로 시작합니다. 이때 대상 1명을 지정하며, 전장 복귀 턴에 한하여 지정한 대상에게 가하는 피해가 4배로 증가합니다.<br>
 *     일도양단 (패시브) : 전장 복귀 턴에 발동합니다. 자신의 턴을 2회 사용할 수 있으며, 기술이 순환의 영향을 받지 않으며, 스태미나 소모 없이 기술을 사용할 수 있습니다.<br>
 *     묵음 (패시브) : 전장 복귀 턴에 피해를 입힌 적에게 다음 턴까지 행동 불가를 부여합니다.<br>
 * *   생사여탈 (패시브) : 전투 시작 턴에 한하여 '암살'의 데미지가 2배로 증가합니다. 전장 복귀 턴에 한하여 암살자가 피해를 입힌 적의 체력이 10% 이하라면 즉시 처형합니다.<br>
 * <p>
 * -   암살 (기술) : 대상에게 4D20의 피해를 입힙니다. (스태미나 44 소모)<br>
 * -   급소 찌르기 (기술) : 대상에게 2D10의 피해를 입힙니다. (스태미나 5 소모)<br>
 * -   목 긋기 (기술) : 대상에게 D20의 피해를 입힙니다. (스태미나 4 소모)<br>
 * -   손목 긋기 (기술) : 대상에게 4D4의 피해를 입힙니다. (스태미나 3 소모)<br>
 * -   후방 공격 (기술) : 대상에게 3D6의 피해를 입힙니다. (스태미나 3 소모)<br>
 * <p>
 *     연막 (스킬) : 자신을 제외한 다른 대상의 첫 턴에 발동 가능합니다. 신속 판정에 성공할 경우, 이번 턴 동안 적에게 행동 불가를 부여하며 전장 이탈이 가능합니다. (마나 4 소모, 쿨타임 10턴)<br>
 *     암살준비 (스킬) : '전장 이탈' 상태일 때 1회 발동할 수 있습니다. 자신의 스태미나와 마나를 각각 20 회복하며, 이후 전장 이탈 동안 휴식을 할 수 없습니다.<br>
 *     타겟 포착 (스킬) : 다음 턴에 무조건 전장에 복귀합니다.<br>
 *     전략적 후퇴 (스킬) : 전장 이탈 상태가 되며, 다음 3턴 이내에 강제로 전장에 복귀합니다. (마나 3 소모, 쿨타임 8턴)<br>
 * *   확인 사살 (스킬) : '암살'을 적중시킨 적의 체력이 30% 이하일 때 발동합니다. 다음 '암살'의 데미지가 2배로 증가합니다. (마나 2 소모, 쿨타임 5턴)<br>
 * -   위장 (전용 수비) : 민첩 판정 성공 시 적의 공격을 회피할 수 있습니다. 신속 판정에 성공할 경우 전장 이탈이 가능하며, 2턴 후 강제로 전장에 복귀합니다. (마나 7 소모)<br>
 */
