 ...
 * <p>
 *     암시야 (패시브) : 전투 시작 시 공격하는 순간까지 은신 상태가 됩니다. 이때 휴식을 할 수 없습니다. 공격 전까지 같은 기술, 스킬은 1회만 사용할 수 있습니다.<br>
 * *   정조준 (패시브) : 자신에게 적용된 버프 스킬 1개당 데미지가 25% 증가합니다.<br>
 * *   급소조준 (패시브) : 5턴 이상 공격하지 않았다면 데미지가 2배로 증가합니다.<br>
 * *   죽음의 탄환 (패시브) : 전투 중 기본 공격을 사용한 적이 없다면 '발사'의 데미지가 1.5배로 증가합니다.<br>
 * <p>
 *     확보 (기술) : 공격 전까지 광역 공격을 받지 않습니다. (스태미나 2 소모)<br>
 * *   조립 (기술) : 다음 공격 데미지가 1.5배로 증가합니다.<br>
 *     장전 (기술) : 탄환을 얻습니다. (스태미나 3 소모)<br>
 * *   조준 (기술) : 다음 공격이 적의 수비를 무시합니다.<br>
 * -   발사 (기술) : 탄환을 소모하여 대상에게 4D20의 피해를 입힙니다. (스태미나 10 소모)<br>
 * <p>
 * *   필즉 (스킬) : 다음 공격이 확정적으로 성공합니다. 다음 턴 공격이 불가능합니다. (마나 3 소모, 쿨타임 10턴)<br>
 * *   안정화 (스킬) : 다음 공격 데미지가 75%로 감소하지만, 주사위를 복제합니다. (마나 4 소모, 쿨타임 10턴)<br>
 * *   몰입 (스킬) : 다음 공격 데미지가 2배로 증가합니다. 공격 전까지 수비가 불가능합니다. (마나 4 소모, 쿨타임 10턴)<br>
 * *   확신 (스킬) : 2턴 동안 공격이 불가능합니다. 다음 공격 데미지가 2.5배로 증가합니다. (마나 3 소모, 쿨타임 10턴)<br>
 * *   신경 극대화 (스킬) : 공격 전까지 받는 데미지가 2배로 증가합니다. 피격 시 모든 버프 효과와 고유 키워드가 제거됩니다. 다음 공격 데미지가 4배로 증가합니다. (마나 8 소모, 쿨타임 10턴)<br>
 *     도주 (스킬) : 다음 턴 행동이 불가능합니다. 2턴 후까지 은신 상태가 됩니다. (마나 3 소모, 쿨타임 10턴)<br>
 */
public class Sniper {
