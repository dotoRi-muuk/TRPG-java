 ...
 * <p>
 * 사냥 (패시브) : 디버프가 적용된 적에게 가하는 피해가 1.5배로 증가합니다.<br>
 * 약육강식 (패시브) : 적보다 자신의 체력 비율이 높다면 모든 스탯이 +2 증가합니다.<br>
 * 직감 (패시브) : 적이 디버프를 얻는 순간 턴에 상관없이 기본 공격을 사용할 수 있습니다.<br>
 * 산탄 (패시브) : 기본 공격 데미지가 2D4로 변경됩니다. 기본 공격 시 (스탯 - 1D20 주사위 값)이 10 이상이라면 2D8로 공격 주사위가 변경됩니다.<br>
 * <p>
 * 장전 (기술) : 다음 턴까지 기본 공격의 데미지가 2D4는 2D6으로, 2D8은 2D12로 변경됩니다. 턴을 소모하지 않습니다. (스태미나 2 소모)<br>
 * 머리찍기 (기술) : 대상에게 1D8의 피해를 입힙니다. (스태미나 1 소모)<br>
 * 덫 깔기 (기술) : 시전 시 판정을 진행하지 않습니다. 적이 공격 시도 시 판정을 시행합니다. 판정 성공 시 1D10의 데미지를 입히며, 해당 턴에 한하여 적의 공격 데미지가 75%로 감소합니다. (스태미나 3 소모)<br>
 * 올가미 탄 (기술) : 대상에게 1D8의 피해를 입힙니다. 다음 턴까지 적에게 행동 불가를 부여합니다. (스태미나 8 소모)<br>
 * 헤드샷 (기술) : 대상에게 2D12의 피해를 입힙니다. (스태미나 4 소모)<br>
 * <p>
 * 사냥터 (스킬) : 2턴 동안 덫을 확정적으로 적중시킵니다. (마나 3 소모, 쿨타임 5턴)<br>
 * 구속 함정 (스킬) : 2턴 동안 적에게 수비 불가를 부여하는 덫을 설치합니다. (마나 6 소모, 쿨타임 8턴)<br>
 * 약자멸시 (스킬) : (자신의 체력% - 적의 체력%)가 10% 이상이라면 다음 턴 적에게 입히는 데미지가 2배로 증가합니다.<br>
 * 압도 (스킬) : (행동, 공격, 수비, 기술 사용, 스킬 사용 등) 불가 상태의 적이 있다면 턴을 연속으로 2회 사용할 수 있습니다. 이 스킬은 턴을 소모하지 않습니다. (마나 6 소모, 쿨타임 8턴)<br>
 * 전리품 (스킬) : 다음 2턴 동안 적에게 피해를 입힐 때마다 '덫 깔기'를 스태미나 소모 없이 발동합니다. (마나 8 소모, 쿨타임 12턴)<br>
 */
