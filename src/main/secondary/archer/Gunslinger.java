 ...
 * <p>
 *     신중함 (패시브) : 전투 외의 상황에서는 총을 넣습니다. 1회 한정 총을 뽑아 공격하며, 해당 공격의 데미지가 3배로 증가합니다.<br>
 *     응징 (패시브) : 반격을 한 번에 2회 진행할 수 있습니다.<br>
 *     노림수 (패시브) : 적의 공격 회피 성공 시 다음 자신의 턴에 데미지가 2배로 증가합니다.<br>
 *     심판자 (패시브) : 전투 시작 후 5번째 턴에, 그리고 매 5턴마다 발동합니다. 기본 공격 발동 시 (1D4)%의 추가 데미지를 입힙니다.<br>
 * <p>
 *     퀵드로우 (기술) : 대상에게 D8의 피해를 입힙니다. '신중함' 발동 시 4D8의 피해를 입힙니다. (스태미나 1 소모)<br>
 *     더블샷 (기술) : 대상에게 2D6의 피해를 입힙니다. (스태미나 2 소모)<br>
 *     헤드샷 (기술) : 대상에게 D20의 피해를 입힙니다. (스태미나 3 소모)<br>
 *     일점사 (기술) : 대상에게 6D6의 피해를 입힙니다. (스태미나 4 소모)<br>
 * <p>
 *     예고장 (스킬) : 대상에게 가하는 반격 데미지가 2배로 증가합니다. (중첩 불가) (마나 6 소모, 쿨타임 15턴)<br>
 *     심판 대상 (스킬) : 지정한 적에게 가하는 데미지가 2배로 증가합니다. 그 외의 대상 공격 시 자신이 피해를 입습니다. (중첩 불가) 쿨타임 이후에 재사용하여 해제하거나 대상을 변경할 수 있습니다. (마나 8 소모, 쿨타임 10턴)<br>
 *     빈틈 발견 (스킬) : 다음 턴까지 반격 시 기본 공격 대신 기술을 사용할 수 있습니다. (마나 4 소모, 쿨타임 4턴)<br>
 *     재정비 (스킬) : 전장에서 이탈합니다. 다음 2턴동안 은신이 지속됩니다. 건슬링거를 타겟팅하는 스킬들이 해제됩니다. (마나 3 소모, 쿨타임 10턴)<br>
 *     경고 (스킬) : 다음 턴까지 반격 데미지가 3배로 증가합니다. 다음 턴까지 반격하지 않을 시, 그 다음 턴에는 공격할 수 없습니다. 해당 스킬은 턴을 소모하지 않습니다. (마나 5 소모, 쿨타임 8턴)<br>
 * <p>
 *     활약 기회 (전용 신속) : 신속 판정 성공 시 이번 턴 반격 데미지가 1.5배로 증가합니다.<br>
 *     백스탭 (전용 수비) : 판정 성공 시 공격을 회피합니다. 1.5배의 데미지로 반격합니다. (스태미나 3 소모)<br>
 */
