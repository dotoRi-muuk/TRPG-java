...
public class SkillService {
    ...
    private String getDisplayName(String methodName) {
        return switch (methodName) {
            ...
            case "ultraSpeed" -> "초신속";
            case "control" -> "제어";
            case "momentaryFatality", "momentaryDeathblow" -> "찰나 속의 필살";
            case "unus" -> "우누스";
            case "duo" -> "두오";
            case "tres" -> "트레스";
            case "quatuor", "quattuor" -> "콰투오르";
            case "que" -> "쿠에";
            case "six", "sex" -> "식스";
            case "septem" -> "세프템";
            case "octo" -> "옥토";
            case "noem", "novem" -> "노엠";
            case "decem", "dekeim" -> "데케임";
            case "throwDagger" -> "투척";
            case "canUseMomentaryTechnique" -> "찰나 기술 사용 가능 여부";
            case "foreseenAssassination", "predictedAssassination" -> "예견된 암살";
            case "namelessSlash" -> "무명참";
            case "conclusion", "finalization" -> "종결";
    ...
    private String getParameterDisplayName(String paramName) {
        return switch (paramName) {
            ...
            case "alreadyUsedInBattle" -> "전투 중 사용 여부";
            case "damageTakenFromEnemyAttack" -> "적 공격 피해량";
            case "accumulatedDamageDuringEffect" -> "찰나 누적 피해";
            case "momentaryFatalityActive" -> "찰나 속의 필살 활성화 여부";
            case "defenseTriggered" -> "수비 발동 여부";
            case "throwMarkBonus" -> "투척 표식 추가량";
            case "hitByDaggerThrow" -> "단검 투척 적중 여부";
            case "targetDaggerMarks" -> "대상 단검 표식 수";
            case "allEnemiesDaggerMarks" -> "모든 적 단검 표식 합";
            case "techniqueName" -> "기술 이름";
            default -> paramName;
        };
    }
